...
add_button = fsg.Button(image_source="img/add.png", size=10, mouseover_colors="Green", tooltip="Add ToDo", key="Add")
list_box = fsg.Listbox(values=functions.get_todos(), key="todos", 
                       enable_events=True, size=[45, 10])
edit_button = fsg.Button("Edit")
complete_button = fsg.Button(image_source="img/complete.png", size=10, mouseover_colors="LightBlue2", tooltip="Complete ToDo", key="Complete")
